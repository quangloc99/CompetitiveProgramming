 ...
 * Editorial: https://codeforces.com/blog/entry/55435
 * This solution has the same idea as in the editorial. But a really quick note: 
 *   The tree of strongly connected component that we must maintain actually is a bambo tree. So it was possible to binary search.
 */
#include <bits/stdc++.h>
using namespace std;
