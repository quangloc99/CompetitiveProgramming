 ...
 * Editorial: https://codeforces.com/blog/entry/64543  (this is unoffical one)
 * The problem is a little hard to read, like the word "zerotrip" is hard for me to understand or "k should not be minimized" is
 * turn out to be "there is no need to minimized k" (I checked the problem in Russian).
 * Idea:
