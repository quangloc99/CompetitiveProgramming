 ...
 * Editorial: https://codeforces.com/blog/entry/63753?locale=en
 * See https://github.com/quangloc99/CompetitiveProgramming/blob/master/SPOJ/APIO10A.cpp for data structure explaination.
 * This time I must use long double instead of llong for checking if a line is removable because the input for this
 * problem is big, but all I need is just checking if is non-negative or not, so it is fine.
 */
#include <bits/stdc++.h>
using namespace std;
