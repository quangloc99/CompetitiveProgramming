 ...
 * This solution has the same idea as in the editorial: https://codeforces.com/blog/entry/47502
 * This is actually a difference between the editorial and this solution: instead of adding new edges, which I think was
 * really hard to track (to print the result), I add a new nodes and connect all nodes with odd degrees to it. That way,
 * we can ez-ly tell if an edge is a new edge or not by checking if one of its endpoints is the new node.
 */
#include <bits/stdc++.h>
using namespace std;
