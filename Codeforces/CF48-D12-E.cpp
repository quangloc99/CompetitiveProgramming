 ...
 * Idea: each of the dragon's state can be thought as a vertex, and if we can go from one state to another by doing a cut, then we got an edge.
 * To encode a state (head, tail) into a vertex, I use this formula: head * maxn + tail.
